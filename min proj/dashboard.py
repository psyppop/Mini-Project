...
class ForenSyncDashboard:
    ...
    def create_main_content(self):
        ...
        buttons = [
            ...
            ("💬  CHAT", self.open_chat),
            ("📷  FACIAL ANALYSIS", self.open_facial_analysis)
        ]

...
class ForenSyncFacilitatorDashboard:
    ...
    def create_main_content(self):
        ...
        buttons = [
            ("🔍 EVIDENCE MANAGEMENT", self.open_evidence_management),
            ("📤 SEND ANALYSIS REPORT", self.send_analysis_report),
            ("📁 EVIDENCE ARCHIVE", self.open_evidence_archive),
            ("🔗 CHAIN OF CUSTODY TRACKER", self.open_custody_tracker),
        ]
...
def facilitator_dash(username="Facilitator", user_type="facilitator"):
    root = Tk()
    ForenSyncFacilitatorDashboard(root, username, user_type)
    root.mainloop()

...
def mainchat():
    ...
    try:
        ...
        try:
            ...
            messagebox.showerror("Connection Error", "No internet connection detected. Please check your network connection.")
            return
        ...
        try:
            ...
            try:
                ...
                try:
                    with open(r"C:\Users\Savio\Desktop\min proj\chatapp-336f3-firebase-adminsdk-fbsvc-875ce7130d.json", 'r') as f:
                        json.load(f)  # This will raise an error if the JSON is invalid
                except json.JSONDecodeError:
                    messagebox.showerror("Firebase Error", "Invalid Firebase credentials file. Please generate a new service account key.")
                    return
                except FileNotFoundError:
                    messagebox.showerror("Firebase Error", "Firebase credentials file not found. Please ensure the file exists.")
                    return
                ...
                messagebox.showerror("Firebase Error", f"Firebase authentication failed: {str(e)}\nPlease check your Firebase credentials and project settings.")
                return
            except Exception as e:
                messagebox.showerror("Error", f"Failed to initialize Firebase: {str(e)}")
                return
    except Exception as e:
